...
def generate_template(age):
    ...
    template_prompt = f"""
        ...
        - Each article box must have:
            - Placeholder title text (e.g., "Article Title 1", "Article Title 2", "Article Title 3").
            - Placeholder paragraph text below the title (e.g., "This is article content.").
            - Unique IDs (article-1, article-2, article-3).
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        #gender_input = gr.Textbox(label="Enter your gender:", placeholder="e.g., Male")
    with gr.Row():
